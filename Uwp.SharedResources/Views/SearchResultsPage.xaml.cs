...
namespace Uwp.SharedResources.Views
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        {
            InitializeComponent();
            _vm = SharedRepository.Instance.Repository.SearchFacadeVm;
            DataContext = _vm;
            _vm.UpdateUi += () =>
            {
        ...
        {
            SharedRepository.Instance.Repository.SharedApp.UpdatePageTitle(TranslationHelper.GetString("SearchResults"));
